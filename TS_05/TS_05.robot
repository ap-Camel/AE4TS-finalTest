...
TC_04_001
    ...
    Click Element  //*[@id="nav"]/li[2]/a
    Click Element  //*[@id="nav"]/li[2]/ul/li[2]/a
    click element  //*[@id="#area2"]
    Click Element  //*[@id="showAddtolistManga"]
    sleep  1
    Click Element  //*[@id="addtolist"]/table/tbody/tr[5]/td[2]/input
    Click Element  //*[@id="header-menu"]/div[2]/a
    Click Element  //*[@id="header-menu"]/div[2]/div/ul/li[2]/a
...
TC_04_006
    ...
    Click Element  //*[@id="nav"]/li[2]/ul/li[2]/a
    click element  //*[@id="#area2"]
    click element  //*[@id="addtolist"]/table/tbody/tr[5]/td[2]/small/a
    Sleep  1
